...
class Vanilla extends Cream{//static binding - what cannot be changed at runtime
	Item item;
	public Vanilla() {
	
}
	public Vanilla(Item item) {//dynamic binding - at constructor level 
		this.item=item;
	}
	public int cost() {
		if(item==null) {
...
public class AbstractDemo {
	...
	public static void main(String[] args) {
		Item iceCream = new Vanilla(new Nuts(new ButterScotch(new DryFruit(new Vanilla()))));
		System.out.println("One Vanilla cup...+Nuts..+ButterScotch:"+iceCream.cost());
